...
<?php endif;?>
<div class="grid_16">
	<h2>Thêm mới nhóm Admin</h2>
</div>

<form action="<?php echo site_url('admin/manageradmin/addGroup')?>" method="post">
<div class="grid_8">
...
<div class="grid_8">
	...
	<p>
	<input type="text" name="comment" value="Nhóm này quản lý gì, ..." onfocus="if(this.value=='Nhóm này quản lý gì, ...'){this.value='';}" onblur="if(this.value==''){this.value='Nhóm này quản lý gì, ...';}" />
	</p>
</div>
...
<div class="grid_16">
	...
	<tr>
		...
		<td><input type="submit" value="Lưu lại thiết lập" name="add" /></td>
	</tr>
	</table>
</div>
</form>
