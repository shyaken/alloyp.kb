...
<div id="content" class="container_16 clearfix">
	...
	<form name="category_form" method="post" action="<?php echo site_url('admin/event/add');?>" enctype="multipart/form-data">
	...
	<div style="float:left; width: 50%;">
		...
		&nbsp;&nbsp;
		<input type="radio" name="active" value="0" checked="checked" />Không
	</div>	
